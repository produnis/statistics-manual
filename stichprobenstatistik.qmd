...
out <- histbackback(split(data$height, data$sex), 
                    ...
                    xlab=c("Männer", "Frauen"), 
                    ylab="Körpergröße")
abline(v= (-8:8)*2 , col ="gray" , lty =3) 
barplot(-out$left, col="skyblue" , horiz=TRUE, space=0, add=TRUE, axes=FALSE) 
barplot(out$right, col="salmon", horiz=TRUE, space=0, add=TRUE, axes=FALSE) 
...
boxplot(height~sex, 
        ...
        col=c("skyblue","salmon"), data=data)
