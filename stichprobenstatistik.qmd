...
# blaue Hilfslinien
lines(c(166.66, 166.66), c(0, 25),  col="skyblue", lty=3)
lines(c(0, 166.66),   c(25, 25), col="skyblue", lty=3)

lines(c(171.67, 171.67), c(0, 40),  col="skyblue", lty=3)
lines(c(0, 171.67),   c(40, 40), col="skyblue", lty=3)


lines(c(174.44, 174.44), c(0, 50),  col="skyblue", lty=3)
lines(c(0, 174.44),   c(50, 50), col="skyblue", lty=3)


lines(c(181.85, 181.85), c(0, 75),  col="skyblue", lty=3)
lines(c(0, 181.85),   c(75, 75), col="skyblue", lty=3)

lines(c(186.67, 186.67), c(0, 88),  col="skyblue", lty=3)
lines(c(0, 186.67),   c(88, 88), col="skyblue", lty=3)
