...
$$
  \begin{array}{|m{3cm}|m{3cm}<{\centering}|m{3cm}<{\centering}|}
...
$$
\begin{array}{|m{1.9cm}|m{1.2cm}<{\centering}|m{1.5cm}<{\centering}|}
...
positiv + & (RP) & (FP) \\ \hline 
\text{Testergebnis}  & \textcolor{red}{\text{falsch negativ}} &
\textcolor{green}{\text{richtig negativ}} \\ 
negativ - &  (FN) &  (RN)\\\hline
\end{array}
$$
