...
- **Anwendungsgebiete:** Ohne Statistik wären Experimententwenteilungen und Datengewinnung in Anwendungswissenschaften nicht möglich oder erfolglos.
...
![Mit einem kleinen Stichprobenumfang ist es schwierig, das Bildmotiv zu ermitteln!](images/Einleitung_sample_windmill1.jpg)
...
![Mit einer großen Stichprobe ist es leichter, das Motiv des Bildes zu erkennen!](images/Einleitung_sample_windmill2.jpg)



Der Vollständigkeit halber enthält nachfolgende @fig-windmuehle1 alle Pixeln der Grundgesamtheit.

![Originalauflösung](images/Einleitung_sample_windmill3.jpg){#fig-windmuehle1}
...
![](images/Einleitung_InduktionDeduktion.png)
...
![](images/Einleitung_statistical_variables.png)
...
![Der statistische Kreislauf](images/Einleitung_Statistikkreis.png)
